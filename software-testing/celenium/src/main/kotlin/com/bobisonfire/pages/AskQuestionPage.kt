...
class AskQuestionPage(private val driver: WebDriver) {
    ...
    init {
        ...
        if (driver.find(By.xpath("//button[@class='grid--cell s-btn s-btn__primary js-modal-primary-btn js-modal-close js-first-tabbable js-modal-initial-focus js-gps-track']")))
            driver.findElement(By.xpath("//button[@class='grid--cell s-btn s-btn__primary js-modal-primary-btn js-modal-close js-first-tabbable js-modal-initial-focus js-gps-track']"))
                .click()
    ...
    fun clickBold() {
        WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath(strongBtnPath)))
        driver.findElement(By.xpath(strongBtnPath)).click()
    }

    fun clickItalic() {
        WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath(italicBtnPath)))
        driver.findElement(By.xpath(italicBtnPath)).click()
    }
    ...
    fun addLink(link: String) {
        ...
        WebDriverWait(
            driver,
            10
        ).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='wmd-inline-dialog js-wmd-inline-dialog-']//input")))
        ...
        driver.findElement(By.xpath("//div[@class='wmd-inline-dialog js-wmd-inline-dialog-']//button[contains(@class, 'js-insert-link-button')]"))
            .click()
    }
    ...
    fun clickQuote() {
        WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath(quoteBtnPath)))
        driver.findElement(By.xpath(quoteBtnPath)).click()
    }

    fun clickCode() {
        WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath(codeBtnPath)))
        driver.findElement(By.xpath(codeBtnPath)).click()
    }

    fun clickImage() {
        WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath(imageBtnPath)))
        driver.findElement(By.xpath(imageBtnPath)).click()
    }
    ...
    fun getPreview(): String {
        WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.xpath(previewPath)))
        return driver.findElement(By.xpath(previewPath)).getAttribute("innerHTML")
    }

    fun isTitlePresented() =
        driver.findElement(By.xpath("//div[contains(@class, 'js-stacks-validation-message') and text() = 'Title is missing.']")) == null

    fun isPostPresented() =
        driver.findElement(By.xpath("//div[contains(@class, 'js-stacks-validation-message') and text() = 'Body is missing.']")) == null

    fun isTagPresented() =
        driver.findElement(By.xpath("//div[contains(@class, 'js-stacks-validation-message') and contains(text(), 'Please enter at least one tag;')]")) == null

    fun isTitleShort() =
        driver.findElement(By.xpath("//div[contains(@class, 'js-stacks-validation-message') and contains(text(), 'Title must be at least 15 characters.')]")) != null

    fun isBodyShort() =
        driver.findElement(By.xpath("//div[contains(@class, 'js-stacks-validation-message') and contains(text(), 'Body must be at least 30 characters;')]")) != null

    fun isTitleHavingError() =
        driver.findElements(By.xpath("//*[@id='post-title' and contains(@class, 'has-error')]")).size > 0

    fun isTagHavingError() =
        driver.findElements(By.xpath("//*[@id='tag-editor']//*[contains(@class, 'js-tag-editor-container') and contains(@class, 'has-error')]")).size > 0
    ...
    fun highlightText(from: Int, to: Int) {
        ...
        (driver as JavascriptExecutor).executeScript(
            "arguments[0].setSelectionRange($from,$to)",
            driver.findElement(By.xpath(inputPostPath))
        )
    }
