package com.bobisonfire.utilities
...
const val DRIVERS_PROVIDER_NAME = "com.bobisonfire.utilities.DriversUtils#provideWebDrivers"
...
class DriversUtils {
    companion object {
        ...
        fun provideWebDrivers(): Stream<List<WebDriver>> {
            val browsers = props.getProperty("browsers").split(" ").map { it }
