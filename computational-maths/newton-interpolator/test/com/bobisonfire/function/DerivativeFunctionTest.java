...
public class DerivativeFunctionTest {
    private final ExtendedFunction x = Variable.from("x");
    ...
    public void test_layered_function_derivative() {
        ExtendedFunction f4 = PowerFunction.from(TrigonometricFunction.from(x, true), 3);
